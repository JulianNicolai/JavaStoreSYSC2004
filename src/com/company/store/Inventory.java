...
public class Inventory {
    ...
    public Inventory() {
        ...
        try {
            this.addNewProduct("1 Gallon Milk Jug (empty)", 15.99, 10, "images/product_images/milk.jpg", "Milk is an emulsion or colloid of butterfat globules within a water-based fluid that contains dissolved carbohydrates and protein aggregates with minerals.");
            ...
            this.addNewProduct("Artisan Loaf", 5.99, 14, "images/product_images/bread.jpg", "Bread is the product of baking a mixture of flour, water, salt, yeast and other ingredients and kneaded until a ball of dough is formed.");
            ...
            this.addNewProduct("55 Gallon Industrial Drum of Mountain Dew (included straw)", 420.69, 8, "images/product_images/dew.jpg", "Mountain Dew is a citrus-flavored soft drink, made by the PepsiCo company. The drink has more caffeine (a stimulant) than other soft drinks like Pepsi and Coca-Cola.");
