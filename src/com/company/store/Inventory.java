...
public class Inventory {
    ...
    public Inventory() {
        ...
        try {
            ...
            this.addNewProduct("55 Gallons of Mountain Dew", 420.69, 8, "images/product_images/dew.jpg", "Mountain Dew is a citrus-flavored soft drink, made by the PepsiCo company. The drink has more caffeine (a stimulant) than other soft drinks like Pepsi and Coca-Cola.");
